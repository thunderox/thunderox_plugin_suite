...
void Delirium_UI_Widget_Selector::Draw(cairo_t* cr)
{
	...
	if (toggle_mode)
	{
		...
		cairo_move_to(cr, x+5,y+font_size+25);
		cairo_line_to(cr, x+w-5,y+font_size+5);
		cairo_stroke(cr);

		cairo_move_to(cr, x+5,30+y+font_size+25);
		cairo_line_to(cr, x+5,30+y+font_size+5);
		cairo_line_to(cr, x+5+(w/2),30+y+font_size+5);
		cairo_line_to(cr, x+5+(w/2),30+y+font_size+25);
		cairo_line_to(cr, x+w-5,30+y+font_size+25);
		cairo_stroke(cr);
