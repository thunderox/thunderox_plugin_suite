...
class triceratopsUI : public UI
{
	public:
		...
		triceratopsUI() : UI(960, 460)
		{
			...
			int widget_env1_attack = Delirium_UI_Create_Widget(GUI, deliriumUI_Fader, 0, 2, 8, 1, 5, "ATTACK", kParametertriceratopsAmount);
			Delirium_UI_Widget_Set_Min_Max(GUI, widget_env1_attack, 1,0);
			Delirium_UI_Widget_Set_Value(GUI, widget_env1_attack, 0);
			// fParameters_widget_number[kParametertriceratopsAmount] = widget_triceratops_amount; 

			int widget_env1_decay = Delirium_UI_Create_Widget(GUI, deliriumUI_Fader, 0, 4.25, 8, 1, 5, "DECAY", kParametertriceratopsAmount);
			Delirium_UI_Widget_Set_Min_Max(GUI, widget_env1_decay, 1,0);
			Delirium_UI_Widget_Set_Value(GUI, widget_env1_decay, 0);
			// fParameters_widget_number[kParametertriceratopsAmount] = widget_triceratops_amount; 

			int widget_env1_sustain = Delirium_UI_Create_Widget(GUI, deliriumUI_Fader, 0, 6.5, 8, 1, 5, "SUSTAIN", kParametertriceratopsAmount);
			Delirium_UI_Widget_Set_Min_Max(GUI, widget_env1_sustain, 1,0);
			Delirium_UI_Widget_Set_Value(GUI, widget_env1_sustain, 0);
			// fParameters_widget_number[kParametertriceratopsAmount] = widget_triceratops_amount; 

			int widget_env1_release = Delirium_UI_Create_Widget(GUI, deliriumUI_Fader, 0, 8.75, 8, 1, 5, "RELEASE", kParametertriceratopsAmount);
			Delirium_UI_Widget_Set_Min_Max(GUI, widget_env1_release, 1,0);
			Delirium_UI_Widget_Set_Value(GUI, widget_env1_release, 0);
			// fParameters_widget_number[kParametertriceratopsAmount] = widget_triceratops_amount; 
			...
			int freak = Delirium_UI_Create_Widget(GUI, deliriumUI_ADSR, 0, 20, 9, 5, 3,"Foggy",0);
		...
		bool onMouse(const MouseEvent& ev) override
		{
			...
			if (ev.button == 1)
			{
				...
				Delirium_UI_Left_Button_Press(GUI, ev.pos.getX(), ev.pos.getY());
				repaint();
